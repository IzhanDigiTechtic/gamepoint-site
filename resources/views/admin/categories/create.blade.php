            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="icon_url" class="form-label">Icon Image (Optional)</label>
                            ...
                            @error('icon_url')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">Max size: 2MB. Recommended: 60x60px square image. Used in category icon bar on homepage.</small>
                        </div>
